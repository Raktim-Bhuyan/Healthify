...
class Constants {
    companion object{
        //properties can be used without having to create specific object of the class
        fun defaultExerciseList():ArrayList<ExerciseModel>{
            ...
            "Wall Sit",R.drawable.ic_wall_sit,false,false)
            ...
            val tricepDipOnChair= ExerciseModel(7,"Triceps Dip On Chair",R.drawable.ic_triceps_dip_on_chair,
            false,false)
